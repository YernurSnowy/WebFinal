...
app.get('/laptops', async (req, res) => {
    const models = ['MacBook Air', 'MacBook Pro 13-inch', 'MacBook Pro 14-inch'];
    ...
    const devicesInfo = [
        {
            ...
            Graphics: 'Apple M1 chip with 7-core GPU / 8-core GPU',
            BatteryLife: 'Up to 15 hours',
            Weight: 'Approx. 1.29 kg (2.8 pounds)'
        },
        {
            DeviceName: 'MacBook Pro 13-inch',
            Brand: 'Apple',
            Display: 'Retina display with True Tone',
            Processor: 'Apple M1 Pro chip or M1 Max chip',
            Memory: '8GB/16GB/32GB unified memory',
            Storage: '512GB/1TB/2TB/4TB/8TB SSD',
            Graphics: 'Integrated 8-core GPU (M1 Pro) or 10-core GPU (M1 Max)',
            BatteryLife: 'Up to 17 hours',
            Weight: 'Approx. 1.4 kg (3.0 pounds)'
        },
        {
            DeviceName: 'MacBook Pro 14-inch',
            Brand: 'Apple',
        Display: 'Mini-LED backlit display with ProMotion',
        Processor: 'Apple M1 Pro chip or M1 Max chip',
        Memory: '8GB/16GB/32GB/64GB unified memory',
        Storage: '512GB/1TB/2TB/4TB/8TB SSD',
        Graphics: 'Integrated 14-core GPU (M1 Pro) or 16-core GPU (M1 Max)',
        BatteryLife: 'Up to 21 hours',
        Weight: 'Approx. 1.6 kg (3.5 pounds)'
        }
    ];
